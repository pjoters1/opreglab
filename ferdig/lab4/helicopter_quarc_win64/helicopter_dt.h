...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&helicopter_B.TravelCounttorad), 0, 0, 30 }
  ,
  ...
  { (char_T *)(&helicopter_DW.Scope_PWORK.LoggedData), 11, 0, 28 },

  { (char_T *)(&helicopter_DW.HILInitialize_ClockModes[0]), 6, 0, 46 },

  { (char_T *)(&helicopter_DW.HILInitialize_POSortedChans[0]), 7, 0, 8 },

  { (char_T *)(&helicopter_DW.FromWorkspace3_IWORK.PrevIndex), 10, 0, 16 },
