 ...
 * C source code generated on : Thu Apr 21 19:43:26 2022
 *
...
typedef struct {
  ...
  real_T TmpSignalConversionAtToFile1Inp[6];
...
typedef struct {
  ...
  struct {
    ...
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWorkspace3_PWORK;              /* '<S6>/From Workspace3' */
  ...
  struct {
    ...
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWorkspace5_PWORK;              /* '<S6>/From Workspace5' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWorkspace6_PWORK;              /* '<S6>/From Workspace6' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWorkspace4_PWORK;              /* '<S6>/From Workspace4' */
  ...
  struct {
    int_T PrevIndex;
  } FromWorkspace3_IWORK;              /* '<S6>/From Workspace3' */
  ...
  struct {
    int_T PrevIndex;
  } FromWorkspace5_IWORK;              /* '<S6>/From Workspace5' */

  struct {
    int_T PrevIndex;
  } FromWorkspace6_IWORK;              /* '<S6>/From Workspace6' */

  struct {
    int_T PrevIndex;
  } FromWorkspace4_IWORK;              /* '<S6>/From Workspace4' */
